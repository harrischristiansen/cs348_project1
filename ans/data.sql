...
insert into Customer(CustomerId, FirstName, LastName, Address, PhoneNo) values (7, 'Cust G', 'Cust Last g', 'ddress6', '765000002');
insert into Customer(CustomerId, FirstName, LastName, Address, PhoneNo) values (8, 'Cust H', 'Cust Last h', 'ddress7', '765000003');
insert into Customer(CustomerId, FirstName, LastName, Address, PhoneNo) values (9, 'Cust I', 'Cust Last i', 'ddress6', '765000002');
...
insert into Product(ProductId, ProductName, Category, SupplierId, ProductDescription) values (5, 'inferno', 'text_books', 4, 'dan brown - inferno');
...
insert into Product(ProductId, ProductName, Category, SupplierId, ProductDescription) values (9, 'Macbook', 'electronics', 3, 'Macbook pro 2017');
insert into Product(ProductId, ProductName, Category, SupplierId, ProductDescription) values (10, 'Foundation of Crypto', 'books', 4, 'Crypto textbook');
...
insert into Inventory(ProductId,TotalStock,LastUpdatedOn) values (8,2,to_date('19900502','YYYYMMDD'));
insert into Inventory(ProductId,TotalStock,LastUpdatedOn) values (9,8,to_date('19900502','YYYYMMDD'));
insert into Inventory(ProductId,TotalStock,LastUpdatedOn) values (10,0,to_date('19900502','YYYYMMDD'));
...
insert into Orders(OrderId,CustomerId,OrderDate,Status) values (8,6,to_date('19900101','YYYYMMDD'),'delayed');

--OrderItems
insert into OrderItems(OrderId,ProductId,Quantity,UnitPrice,Discount) Values (1,1,1,800.0,15);
insert into OrderItems(OrderId,ProductId,Quantity,UnitPrice,Discount) Values (1,1,1,800.0,10);
insert into OrderItems(OrderId,ProductId,Quantity,UnitPrice,Discount) Values (2,1,1,900.0,10);
insert into OrderItems(OrderId,ProductId,Quantity,UnitPrice,Discount) Values (2,2,1,300.6,7.5);
...
insert into OrderItems(OrderId,ProductId,Quantity,UnitPrice,Discount) Values (6,5,1,13.5,5.5);
insert into OrderItems(OrderId,ProductId,Quantity,UnitPrice,Discount) Values (7,2,1,10.5,0);
insert into OrderItems(OrderId,ProductId,Quantity,UnitPrice,Discount) Values (8,9,1,1100.5,0);
